...
namespace WebApi.Controllers
{
    ...
    public class AboutsController : ControllerBase
    {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<About>> PostAbout(About about,string path)
        {
            about = new About();
            Xulyanh xl = new Xulyanh();
            about.About_Image = xl.Xuly(path);
            _context.Abouts.Add(about);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetAbout", new { id = about.Id_About }, about);
        }
        ...
        {
            return _context.Abouts.Any(e => e.Id_About == id);
        }
    }
}
